                    ...
                    <div class="container">
                        <form action="{{ route('kategoris.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-10">
                                    <input type="file" class="form-control form-control-md" name="image" accept="image/png, image/jpeg" required />
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-10">
                                    <input type="text" class="form-control form-control-md" name="kategori" placeholder="Inputkan Type" value="{{ Session::get('kategori') }}" required />
                                </div>
                            </div>
